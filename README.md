...
| Dashboard | Runs Explorer |
|---|---|
| ![Dashboard](https://raw.githubusercontent.com/deegrate/flowscope/main/public/screenshots/dashboard.png) | ![Runs](https://raw.githubusercontent.com/deegrate/flowscope/main/public/screenshots/runs.png) |

| Run Detail | Prompts |
|---|---|
| ![Run Detail](https://raw.githubusercontent.com/deegrate/flowscope/main/public/screenshots/run-detail.png) | ![Prompts](https://raw.githubusercontent.com/deegrate/flowscope/main/public/screenshots/prompts.png) |
...
dozens of LLM calls, tool invocations, HTTP fetches, and data transformations.
...
### Dashboard
- Real-time KPI cards: total runs, success rate, average latency, and estimated daily cost
...
- Complete execution summary: model, prompt version, duration, token count, estimated cost, and timestamps
- Auto-generated run summary sentence based on execution outcome
- Step-by-step timeline with type icons (LLM / tool / HTTP / transform), per-step duration, and status indicators
...
fetching; client components handle interactivity. Framer Motion is used
...
git clone https://github.com/deegrate/flowscope.git
cd flowscope
